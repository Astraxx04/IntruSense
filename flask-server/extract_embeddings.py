...
def extactemb():
	...
	protoPath = r"/Users/gagans/Desktop/ahmed/IntruSense/flask-server/face_detection_model/deploy.prototxt"
	modelPath = r"/Users/gagans/Desktop/ahmed/IntruSense/flask-server/face_detection_model/res10_300x300_ssd_iter_140000.caffemodel"
	detector = cv2.dnn.readNetFromCaffe(protoPath, modelPath)

	# load serialized face embedding model
	print("Loading Face Recognizer...")
	embedder = cv2.dnn.readNetFromTorch(r"/Users/gagans/Desktop/ahmed/IntruSense/flask-server/face_detection_model/openface_nn4.small2.v1.t7")
	...
	f = open(r"/Users/gagans/Desktop/ahmed/IntruSense/flask-server/output/embeddings.pickle", "wb")
